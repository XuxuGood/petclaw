...
pnpm ai:tools:check                            # 工具链快速状态检查
pnpm ai:doctor                                 # 深度诊断 GitNexus / Serena / MCP / 锁 / 权限
pnpm ai:serena:dashboard                       # 查看当前可访问的 Serena Dashboard 地址
```

完整设计见 [`docs/架构设计/AI代码上下文工程设计.md`](../docs/架构设计/AI代码上下文工程设计.md)。渲染进程、Preload API 和桌面 UI/UX 边界见 [`docs/架构设计/PetClaw前端架构设计.md`](../docs/架构设计/PetClaw前端架构设计.md)。
