...
This project is indexed by GitNexus as **petclaw** (7901 symbols, 13361 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
